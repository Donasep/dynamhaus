	...
	if (submitButton) {
			submitButton.addEventListener('click', function (event) {
					...
					if (!passwordsMatch) {
							...
							errorLabelPass.innerHTML = '<img src="/public/icons/exclamation.svg"/><p>Les mots de passe ne correspondent pas.</p>';
					} else {
					...
					if (hasError) {
							...
							errorLabelInput.innerHTML = '<img src="/public/icons/exclamation.svg"/><p>Les champs indiqués en rouge sont obligatoires.</p>';
					}
					...
					if (!hasError) {
							...
							xmlhttp.open("POST", "/inscription", true);
							...
							xmlhttp.onreadystatechange = function () {
									if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
											...
											if (userCreated === "ok") {
													...
													errorLabelPass.innerHTML = '';
													errorLabelPass.setAttribute('class', 'errorMessage');
													errorLabelPass.innerHTML = '<img src="/public/icons/exclamation.svg"/><p>Cet e-mail est déjà utilisé</p>';
											} else {
